...
#define VDM_WINDOW_HOME											20000
#define	VDM_WINDOW_MOVIES_FILTER						(VDM_WINDOW_HOME + 1)
#define	VDM_WINDOW_MOVIES_FILTER_ITEM				(VDM_WINDOW_HOME + 2)
#define VDM_WINDOW_MOVIE_INFO								(VDM_WINDOW_HOME + 3)
#define VDM_WINDOW_MOVIE_OSD								(VDM_WINDOW_HOME + 4)
#define VDM_WINDOW_PICTURE_PREVIEW					(VDM_WINDOW_HOME + 5)
#define VDM_WINDOW_MOVIE_OSD_KEY						(VDM_WINDOW_HOME + 6)
#define VDM_WINDOW_MOVIE_MENU								(VDM_WINDOW_HOME + 7)
#define VDM_WINDOW_PICTURE									(VDM_WINDOW_HOME + 8)
#define VDM_WINDOW_PICTURE_OSD							(VDM_WINDOW_HOME + 9)
#define VDM_WINDOW_SERVER_SELECT						(VDM_WINDOW_HOME + 10)
#define VDM_WINDOW_LANGUAGE_SELECT					(VDM_WINDOW_HOME + 11)
#define VDM_WINDOW_PICTURE_MENU							(VDM_WINDOW_HOME + 12)
#define VDM_WINDOW_FILE_BROWSER							(VDM_WINDOW_HOME + 13)
#define VDM_WINDOW_SETTING_ITEM							(VDM_WINDOW_HOME + 14)
#define VDM_WINDOW_WAITING									(VDM_WINDOW_HOME + 15)
#define VDM_WINDOW_MEDIASOURCE_MANAGER			(VDM_WINDOW_HOME + 16)
#define VDM_WINDOW_MEDIASOURCE_ADD					(VDM_WINDOW_HOME + 17)
#define VDM_WINDOW_SERVER_DIRECTORY_BROWSER	(VDM_WINDOW_HOME + 18)
#define VDM_WINDOW_CHECK_NEW_VERSION    		(VDM_WINDOW_HOME + 19)
#define VDM_WINDOW_MESSAGEBOX								(VDM_WINDOW_HOME + 20)
#define VDM_WINDOW_DELETE_MEDIASOURCE_PROGRESS		(VDM_WINDOW_HOME + 21)
#define VDM_WINDOW_INFORMATION							(VDM_WINDOW_HOME + 22)
#define VDM_WINDOW_UPGRADE_NOTE							(VDM_WINDOW_HOME + 23)
#define VDM_WINDOW_LOADING_MOVIES						(VDM_WINDOW_HOME + 25)
#define VDM_WINDOW_FREEVERSION_NOTE					(VDM_WINDOW_HOME + 26)
#define VDM_WINDOW_PLAYERROR_NOTE						(VDM_WINDOW_HOME + 27)
#define VDM_WINDOW_FILES_SETTING						(VDM_WINDOW_HOME + 28)
#define VDM_WINDOW_TVSHOW_INFO							(VDM_WINDOW_HOME + 29)
#define VDM_WINDOW_VIDEO_RESOLUTIONS        (VDM_WINDOW_HOME + 30)
#define VDM_WINDOW_PLAYMODE_3D							(VDM_WINDOW_HOME + 31)
#define VDM_WINDOW_SOURCE_TYPE              (VDM_WINDOW_HOME + 32)
#define VDM_WINDOW_PLAYMODE_BD							(VDM_WINDOW_HOME + 33)
#define VDM_WINDOW_AUDIO_OUTPUT             (VDM_WINDOW_HOME + 34)
#define VDM_WINDOW_AUDIO_SPEAKERS           (VDM_WINDOW_HOME + 35)
#define VDM_WINDOW_AUDIO_CAPABLE            (VDM_WINDOW_HOME + 36)
#define VDM_WINDOW_AUDIO_DEVICE             (VDM_WINDOW_HOME + 37)
#define VDM_WINDOW_AUDIO_PASSTHROUGH        (VDM_WINDOW_HOME + 38)
#define VDM_WINDOW_SUBTITLE_FONT            (VDM_WINDOW_HOME + 39)
#define VDM_WINDOW_SUBTITLE_CHARACTER       (VDM_WINDOW_HOME + 40)
#define VDM_WINDOW_SUBTITLE_SIZE            (VDM_WINDOW_HOME + 41)
#define VDM_WINDOW_SUBTITLE_COLOR           (VDM_WINDOW_HOME + 42)
#define VDM_WINDOW_MEDIA_FILTER             (VDM_WINDOW_HOME + 43)
#define VDM_WINDOW_MEDIA_FILTER_ITEM        (VDM_WINDOW_HOME + 44)
#define VDM_WINDOW_TVSHOWS_FILTER           (VDM_WINDOW_HOME + 45)
#define VDM_WINDOW_VIDEOS_FILETER           (VDM_WINDOW_HOME + 46)
#define VDM_WINDOW_TVSHOWS_FILTER_ITEM      (VDM_WINDOW_HOME + 47)
#define VDM_WINDOW_VIDEOS_FILTER_ITEM       (VDM_WINDOW_HOME + 48)
#define VDM_WINDOW_INTRODUCTION				      (VDM_WINDOW_HOME + 49)
#define VDM_WINDOW_BUY								      (VDM_WINDOW_HOME + 50)
#define VDM_WINDOW_BUY_NOTE								  (VDM_WINDOW_HOME + 51)
#define VDM_WINDOW_FEATURE_LIMIT_NOTE				(VDM_WINDOW_HOME + 52)
#define VDM_WINDOW_FEATURE_LIMIT_NOTEEX			(VDM_WINDOW_HOME + 53)
#define VDM_WINDOW_DOLBY_DTS								(VDM_WINDOW_HOME + 54)
#define VDM_WINDOW_LOG_SEND									(VDM_WINDOW_HOME + 55)
#define VDM_WINDOW_SYSTEM_UPDATE						(VDM_WINDOW_HOME + 56)
#define VDM_WINDOW_UPDATE_SCHEDULE					(VDM_WINDOW_HOME + 57)
#define VDM_WINDOW_UPDATE_ERROR					(VDM_WINDOW_HOME + 58)
#endif
