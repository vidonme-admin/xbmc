...
namespace JSONRPC
{
  ...
  const char* const JSONRPC_SERVICE_METHODS[] = {  
    ...
    "}",
		...
		"\"Player.FastForward\": {"
		"\"type\": \"method\","
		"\"description\": \"Player.FastForward\","
		"\"transport\": \"Response\","
		"\"permission\": \"ControlPlayback\","
		"\"params\": [],"
		"\"returns\": \"string\""
...
#if defined(__VIDONME_MEDIACENTER__)
        "{ \"name\": \"resume\", \"type\": \"number\", \"minimum\": 0 },"
#endif
